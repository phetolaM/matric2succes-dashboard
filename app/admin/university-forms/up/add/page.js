...
const levelOptions = ["Bachelor", "Higher Certificate", "Diploma"];
...
const normalizeLevelForDisplay = (level) => {
    ...
    if (map[normalizedLevel]) return map[normalizedLevel];
    if (normalizedLevel.startsWith("bachelor")) return "Bachelor";
    return "Higher Certificate";
};

export default function AddCourseUPPage() {
        ...
        <div className={styles.container}>
            <header className={styles.header}>
                ...
                <div>
                    ...
                    <h1 className={styles.title}>University of Pretoria</h1>
                </div>
            </header>
            ...
            <form onSubmit={handleSubmit} className={formStyles.form}>
                <div className={formStyles.section}>
                    ...
                    <div className={formStyles.fieldGroup}>
                        <label className={formStyles.label}>Course Type</label>
                        <select
                ...
                <div className={formStyles.section}>
                    ...
                    <div className={formStyles.fieldGroup}>
                        <label className={formStyles.label}>Course APS</label>
                        <input
                            type="number"
                    ...
                    <div className={formStyles.fieldGroup}></div>
                </div>

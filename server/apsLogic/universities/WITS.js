export const meta = {
    code: "wits",
    displayName: "University of the Witwatersrand",
    collections: ["wits"],
    mathSubjects: [
...
export function calculateAPS(data) {
    // Points tables
    function engMathPoints(percent) {
    ...
    (data.otherSubjects || []).forEach((subject) => {
        if (
            ...
            !/technical mathematics/i.test(subject.subject) &&
    ...
    console.log(`WITS APS Score:  ${aps}`);
    return { aps };
}

...
const CPUTCourseSchema = new mongoose.Schema(
    {
        ...
        APSCalculationMethod: { type: String, trim: true },
    ...
    { timestamps: true, collection: "cput" },
);

CPUTCourseSchema.index({ courseName: 1 });
CPUTCourseSchema.index({ apsRequirement: 1 });

export default CPUTCourseSchema;
